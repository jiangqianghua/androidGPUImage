...
public class GPUImageBilateralBlurFilter extends BaseGPUImageFilter {
    ...
    public GPUImageBilateralBlurFilter(Context context) {
        this(context,8.0f);
    }

    public GPUImageBilateralBlurFilter(Context context,final float distanceNormalizationFactor) {
        super(context);
    ...
    public void update() {
        ...
        super.update();
        setFloat(disFactorLocation, distanceNormalizationFactor);
    }
    ...
    public void onOutputSizeChanged(final int width, final int height) {
        ...
        setFloatVec2(singleStepOffsetLocation, new float[]{1.0f / width, 1.0f / height});
    }
