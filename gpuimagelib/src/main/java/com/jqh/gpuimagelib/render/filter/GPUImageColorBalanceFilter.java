...
public class GPUImageColorBalanceFilter extends BaseGPUImageFilter {
    ...
    public GPUImageColorBalanceFilter(Context context) {
        ...
        super(context);
        this.showdows = new float[]{0.5f, 0.5f, 0.5f};
        this.midtones = new float[]{0.2f, 0.2f, 0.2f};
        this.highlights = new float[]{0.8f, 0.8f, 0.8f};
    ...
    public String getFragmentSource() {
        return GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER;
    }
}
